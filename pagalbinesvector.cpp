...
void testai() {
    ...
    // Konstruktoriu patikrinimas
    {
        ...
        //Zmogus C(var, pav, vid, egz, paz, galutinis, med);
        Pazymiai C; // Declare an object of type Pazymiai
C.setVar(var); // Set the attributes using setter methods
C.setPav(pav);
C.setVid(vid);
C.setEgz(egz);
C.setPazymiai(paz);
C.setGalutinis(galutinis);
C.setMed(med);
    ...
    // Copy konstruktoriaus patikrinimas
    {
        ...
        Pazymiai zmogus; // Declare an object of type Pazymiai
zmogus.setVar(var); // Set the attributes using setter methods
zmogus.setPav(pav);
zmogus.setVid(vid);
zmogus.setEgz(egz);
zmogus.setPazymiai(paz);
zmogus.setGalutinis(galutinis);
zmogus.setMed(med);
